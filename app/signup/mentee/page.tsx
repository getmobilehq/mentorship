...
export default function MenteeSignUpPage() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    try {
      await signUp(values.email, values.password, 'mentee');
      toast({
        title: 'Success',
      ...
      <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[450px]">
        <Card>
          <CardHeader className="space-y-1">
            <CardTitle className="text-2xl font-bold">Create a mentee account</CardTitle>
            <CardDescription>
              Enter your information to get started as a mentee
            </CardDescription>
          </CardHeader>
